...
class CaseupdatesType extends AbstractObjectType   // extending abstract Object type
{
    ...
    {
        foreach (argsHelper::entityArgsHelper('AopCaseUpdates') as $field => $type) {
    ...
    {
        return 'AopCaseUpdates';  // important to use the real name here, it will be used later in the Schema
    }
}
