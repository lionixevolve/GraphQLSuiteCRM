...
It is coming along nicely, has better performance, and I am using 100% V8 API endpoints (oauth-tokens instead of cookies).
...
Can be integrated with SuiteCRM v8 API to be used with its native authentication.
